...
const socialLinks = [
  {
    id: 1,
    title: "Felix's Github Profile",
    link: "https://https://github.com/tianyinggang",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 2,
    title: "Felix's LinkedIn Profile",
  ...
  {
    id: 4,
    title: "Felix's Profile on Facebook",
